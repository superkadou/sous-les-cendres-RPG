...
humeur dominante = +1D
chaque humeur a un score de base egal a la moitie des pips investis dans la caracteristiques associee arrondis a l'inferieur . Ex : Coeur : 2D+2 = 8 pips => Sang 4 pips = 1D+1
Lorsqu'il effectue une action, un personnage peux puiser dans l'humeur associée à l'action afin d'aumgmenter ses chances de reussites.
