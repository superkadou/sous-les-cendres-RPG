### I. De l'Art d'Inuenter & de Tisser les Intrigues

Le Maistre du Jeu est le grand architecte des songes. Son rôle n'est point de dicter un chemin, mais de disposer des jalons sur lesquels les pas des joueurs viendront bâtir une chronique.

*   **La Structure du Conte :** Toute bonne geste se décline en trois actes. L'**Ouverture** doit frapper les esprits par un péril ou une énigme. Le **Développement** est un entrelacs de rencontres et de lieux (abbayes sombres, forêts hostiles, foires grouillantes) où le danger côtoie l'opportunité. Enfin, le **Climax** est l'heure de vérité où le sort bascule.
*   **Les Ames du Monde :** Peuples et PNJ ne sont point de simples silhouettes. Donnez-leur un désir (l'or, la foi, la vengeance) et une faiblesse. Un monde vivant est un monde où chaque personnage a son propre agenda, indépendant de celui des héros.
*   **L’Invention Subite :** L'improvisation est l'outil souverain. Quand les joueurs délaissent le palais pour la ruelle, le MJ doit savoir transformer une ombre en menace et un mendiant en porteur de secrets.

### II. De la Conduite des Compagnons & de l'Entente à Table

La table est un cercle de confiance où la parole de chacun doit peser avec équité. Le jeu n'est point une joute entre le MJ et les Compagnons, mais une œuvre commune.
...
Les règles sont des servantes, non des maîtresses. Si le grimoire des lois devient une entrave à la bravoure ou au récit, le MJ possède le droit régalien de le simplifier.
...
| :--- | :--- | :--- | :--- |
| **1** | Ciel tourmenté | Bourse de deniers | Guet-apens |
| **2** | Voyageur loquace | Relique mineure | Chausse-trape |
| **3** | Rumeur de village | Outil de maître | Maladie/Poison |
| **4** | Animal étrange | Parchemin secret | Autorité hostile |
| **5** | Dispute civile | Clef rouillée | Éboulement |
| **6** | Présage divin | Objet d'art | Trahison |
