...
- **La simplicité** (des règles accessibles),
- **La créativité** (un cadre qui inspire les joueurs sans les contraindre).

Si vous êtes **puriste**, libre à vous d’adapter les éléments pour coller davantage à la réalité historique. Mais sachez que chaque écarts est **assumé, réfléchi, et au service du jeu**.
