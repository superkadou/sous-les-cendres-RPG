...
* Les règles se trouvent dans le dossier `/rules`.
...
* Un bestiaire profane et un bestiaire mystique sont dans le dossier `/assets`.
...
2. **Licence artistique** :
   Le jeu emprunte à des **symboles, des motifs et des styles** issus de périodes voisines (Renaissance, début de l’époque moderne) ou même de **l’imaginaire fantastique**, pour renforcer l’**atmosphère onirique et occulte** de l’univers. Les anachronismes **assumés** (comme des armures trop ornées ou des vêtements "trop propres" pour l’époque) servent à **créer une esthétique cohérente avec le ton du jeu** : un mélange de **réalisme brut** et de **mysticisme poétique**.

3. **Accessibilité** :
   Certains termes, mécaniques ou représentations visuelles sont **modernisés ou simplifiés** pour être **compréhensibles et utilisables** sans nécessiter un doctorat en histoire médiévale. L’objectif est de permettre à tous les joueurs et joueuses— qu’ils/elles soient **historiens ou néophytes** — de s’approprier rapidement l’univers et de se concentrer sur **l’aventure et le récit**.
...
Si vous êtes **puriste**, libre à vous d’adapter les éléments pour coller davantage à la réalité historique. Mais sachez que chaque écart est **assumé, réfléchi, et au service du jeu**.
...
— *superkadou, auteur*
---
*Fait avec dévotion dans le scriptorium de GitHub par superkadou. @ 2026*
